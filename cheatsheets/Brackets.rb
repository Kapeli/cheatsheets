cheatsheet do
  ...
  category do
    ...
    entry do
      command 'CMD+FN+Arrow Left'
      name 'Goto file start'
    end
    entry do
      command 'CMD+FN+Arrow Right'
      name 'Goto file end'
    end
    entry do
      command 'FN+Arrow Up'
  ...
  category do
    ...
    entry do
      command 'CMD+CTRL+G'
      name 'Find all and select'
    end
    entry do
      command 'CMD+B'
      name 'Add next match to selection'
    end
    entry do
      command 'CMD+SHIFT+B'
      name 'Skip and add next match to selection'
    end
  end
  ...
  category do
    ...
    entry do
      command 'CMD+]'
      name 'Indent current line or selection'
    end
    entry do
      command 'CMD+['
      name 'Outdent current line or selection'
    end
    entry do
      command 'CMD+Return'
      name 'Insert newline after current line or selection'
    end
    entry do
      command 'CMD+SHIFT+Return'
      name 'Insert newline before current line or selection'
    end
    entry do
      command 'CTRL+SHIFT+D'
      name 'Delete current line or selection'
    end
    entry do
  ...
  category do
    ...
    entry do
      command 'CTRL+Space'
      name 'Show code hints'
    end
    entry do
      command 'CTRL+SHIFT+Space'
      name 'Show parameter hint'
    end
  end
  ...
  category do
    ...
    entry do
      command 'CMD+SHIFT+C'
      name 'Toggle live preview highlight'
    end
    entry do
      command 'CMD+SHIFT+R'
      name 'Force reload of live preview'
    end
  end
  ...
  category do
    ...
    entry do
      command 'CMD+R'
      name 'Reload with extensions'
    end
    entry do
      command 'CMD+CTRL-R'
      name 'Reload without extensions'
    end
  end
  ...
  category do
    ...
    entry do
      command 'CMD+0'
      name 'Restore font size to default'
    end
  ...
  notes <<-'END'
    * Created by [David Waterston](https://github.com/davidwaterston).
  END
end