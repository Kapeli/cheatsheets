...
category do
	...
	entry do
  		notes '
  		```css
  		@media only screen and (min-device-width: 601px) and (max-device-width: 906px) and (-webkit-min-device-pixel-ratio: 1.331) and (-webkit-max-device-pixel-ratio: 1.332) and (orientation: portrait)
	```'
	...
	entry do
  		notes '
  		```css
  		@media only screen and (min-device-width: 601px) and (max-device-width: 906px) and (-webkit-min-device-pixel-ratio: 1.331) and (-webkit-max-device-pixel-ratio: 1.332) and (orientation: landscape)
	```'
	...
	entry do
  		notes '
  		```css
  		@media only screen and (min-device-width: 800px) and (max-device-width: 1280px) and (-webkit-min-device-pixel-ratio: 1.5) and and (orientation: portrait)
	```'
...
category do
	...
	entry do
  		notes '
  		```css
  		@media only screen and (min-device-width: 1200px) and (max-device-width: 1600px) and (-webkit-min-device-pixel-ratio: 1.5) and and (orientation: portrait)
	```'
