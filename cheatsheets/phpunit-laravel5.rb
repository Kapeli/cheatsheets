cheatsheet do
  title 'PHPUnit in Laravel 5'               
  docset_file_name 'PHPUnit-Laravel-5'   
  keyword 'phpunit'             
  # resources 'resources_dir'  # An optional resources folder which can contain images or anything else

  introduction '## PHPUnit in Laravel 5 using Laracasts/integrated component'  # Optional, can contain Markdown or HTML
  ...
  notes <<-'END'
  	* Based on the <a href="https://github.com/laracasts/Integrated">oficial documentation</a>
