cheatsheet do
	...
	category do
		...
		entry do
			name 'Single Selection (when there are multiple select­ions; exits to visual mode first if you are in insert mode)'
			notes "
				```
				⎋
				```"
	...
	category do
		...
		entry do
			name 'Next Result (file search results)'
			notes "
				```
				F4
				```"
