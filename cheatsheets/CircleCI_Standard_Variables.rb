cheatsheet do
 ...
 category do
   ...
   entry do
     ...
     notes %|(**String**) The name of the GitHub or Bitbucket repository where the pull request was created. Only available on forked PRs.|
   end
  ...
  category do
   ...
   entry do
    ...
    entry do
     ...
     notes %|(**String**) The name of the schedule if it is a scheduled pipeline. Value will be empty string if the pipeline is triggered by other sources.|
   end    
   
   entry do
     name '`pipeline.schedule.id`'
     notes %|(**String**) The unique id of the schedule if it is a scheduled pipeline. Value will be empty string if the pipeline is triggered by other sources.|
   end    
  end  
end	
